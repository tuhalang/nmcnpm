                ...
                <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                    <div class="panel panel-teal panel-widget border-right">
                        <div class="row no-padding">
                            <em class="far fa-xl fa-kiss-wink-heart color-blue"></em>
                            <div class="large">120</div>
                            <div class="text-muted">New Kipalog</div>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                ...
                <div class="panel panel-default chat">
                    ...
                    <div class="panel-footer">
                        <div class="input-group">
                            <input <%--id="btn-input"--%> typinpute="text" class="form-control input-md" placeholder="Type your message here..." /><span class="input-group-btn">
