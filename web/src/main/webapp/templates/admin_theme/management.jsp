        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel panel-default" id="container-pages">
                    ...
                    <div id="list-user1" class="panel-body">
                        <div class="item-user">
                            <img class="avatar left" src="http://placehold.it/50/30a5ff/fff">
                            <div class="info left">
                            ...
                            <div class="edit-user right">
                                ...
                                <a class="center config-user left">
                                    <i class="fas fa-user-cog"></i>
                                    <p>Config User</p>
                                </a>
                                <a class="center delete-user left">
