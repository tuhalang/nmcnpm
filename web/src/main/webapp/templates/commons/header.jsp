        ...
        <ul class="navbar-nav">
            <li class="nav-item col-sm-3 px-0 ml-md-5">
                <a class="nav-link px-0 font-weight-bold" href="#"><i
                        class="fas fa-map-marked-alt fa-2x float-left mr-md-2 mt-md-1"></i>Theo dõi<br>đơn hàng</a>
            </li>
            ...
            <li class="nav-item dropdown mr-md-4">
                ...
                <ul class="dropdown-menu add-to-ul" aria-labelledby="navbarDropdownMenuLink">
                    <li class="dropdown-submenu">
                        <a class="dropdown-item dropdown-toggle" data-toggle="dropdown" href="#"><i
                                class="fas fa-mobile-alt"></i>Điện Thoại - Máy Tính Bảng</a>
                        <div class="dropdown-menu mega-menu">
                            <div class="row">
                                <div class="col sub-menu">
                                    <ul>
                                        <li><a class="dropdown-item font-weight-bold" href="#">Xu hướng & Nổi Bật</a>
                                        </li>
                                ...
                                <div class="col sub-menu">
                                    <ul>
                                        <li><a class="dropdown-item font-weight-bold" href="#">Smartphone chính hãng</a>
                                        </li>
                                        <li><a class="dropdown-item" href="#">iPhone</a></li>
                    ...
                    <li class="dropdown-submenu">
                        <a class="dropdown-item" href="#"><i class="fas fa-basketball-ball"></i></i></i>Thể Thao - Dã
                            Ngoại</a>
                        <div class="dropdown-menu mega-menu">
                            <div class="row">
                                <div class="col sub-menu">
                    ...
                    <li class="dropdown-submenu">
                        <a class="dropdown-item" href="#"><i class="fas fa-ticket-alt"></i>Voucher - Dịch Vụ - Thẻ
                            Cào</a>
                        <div class="dropdown-menu mega-menu">
                            <div class="row">
                                <div class="col sub-menu">
