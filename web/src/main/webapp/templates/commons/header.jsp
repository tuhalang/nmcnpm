            ...
            <li class="nav-item dropdown mr-md-4">
                ...
                <ul class="dropdown-menu add-to-ul" aria-labelledby="navbarDropdownMenuLink">
                    <li class="dropdown-submenu">
                        <a class="dropdown-item" href="home?categoryId=1"><i class="fas fa-mobile-alt"></i>Điện Thoại</a>
                    </li>
                    <li class="dropdown-submenu">
                        <a class="dropdown-item" href="home?categoryId=2"> <i class="fas fa-tablet"></i>Máy Tính Bảng</a>
                    </li>
                    <li class="dropdown-submenu">
                        <a class="dropdown-item" href="home?categoryId=3"><i class="fas fa-tv"></i>Điện Tử - Điện Lạnh</a>
                    </li>
                    <li class="dropdown-submenu">
                        <a class="dropdown-item" href="home?categoryId=4"><i class="fas fa-headphones"></i>Phụ Kiện - Thiết Bị Số</a>
                    </li>
                    <li class="dropdown-submenu">
