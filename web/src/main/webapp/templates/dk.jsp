<%-- 
    Document   : dk
    Created on : Nov 30, 2019, 12:19:05 AM
    Author     : ADMin
--%>
...
<div class="" tabindex="-1" role="dialog" style="position: relative;
 ...
 <span><label for="full_name" style=" " >Họ tên</label>
 <input type="text" id="full_name" name="txtName" placeholder="Nhập họ tên" class="Input-sc-1sflv1m-0 coLFjn" style="margin-left:93px">
</span></div>
  <div class="UserModalstyle__FormItem-uq4a18-6 llEucX" id="b">
 <span><label for="phone_number" style=" ">SĐT</label>
<input type="text" id="phone_number" name="txtPhone" placeholder="Nhập số điện thoại" class="Input-sc-1sflv1m-0 coLFjn" style="margin-left:104px" >
  </div>
  <div class="UserModalstyle__FormItem-uq4a18-6 llEucX" id="d">
  <span><label for="email" style=" ">Email</label>
  <input type="text" id="email" name="txtEmail" placeholder="Nhập email" class="Input-sc-1sflv1m-0 coLFjn" style="margin-left:98.5px">
  </div>
  <div class="UserModalstyle__FormItem-uq4a18-6 llEucX" id="dn">
  <span><label for="user_name" style=" ">Tên đăng nhập</label>
  <input type="text" id="user_name" name="txtUsername" placeholder="Nhập tên đăng nhập" class="Input-sc-1sflv1m-0 coLFjn" style="margin-left:53px">
  </div>
  <div class="UserModalstyle__FormItem-uq4a18-6 llEucX" id="e">
  <span><label for="password" style=" ">Mật khẩu</label>
  <input type="password" id="password" name="txtPassword" placeholder="Mật khẩu từ 6 đến 32 ký tự" class="Input-sc-1sflv1m-0 coLFjn" style="margin-left:81px">
</div>

<div class="UserModalstyle__FormItem-uq4a18-6 llEucX" id="f">
  <span><label for="re_password" style=" ">Nhập lại mật khẩu</label>
  <input type="password" id="re_password" name="txtRePass" placeholder="Mật khẩu từ 6 đến 32 ký tự" class="Input-sc-1sflv1m-0 coLFjn" style="margin-left:35.8px">
</div>
<div class="UserModalstyle__FormItem-uq4a18-6 llEucX" id="g">
  <span><label for="address" style=" ">Địa chỉ</label>
  <input type="text" id="address" name="txtAddress" placeholder="Nhập địa chỉ" class="Input-sc-1sflv1m-0 coLFjn"style="margin-left:94.8px" >
</div>
