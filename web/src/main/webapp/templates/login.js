...
var email = document.getElementById('email').value;
  var data='<div class="UserModalstyle__FormItem-uq4a18-6 llEucX" id="b"><span><label for="email" style="margin:5px 13px 0px 0px" class="xd">Tên đăng nhập</label><input type="text" id="email" name="txtUsername" placeholder="Nhập tên đăng nhập" class="Input-sc-1sflv1m-0 qJuWA" ><div class="InputError-xeouh7-0 dLpXwR">Vui lòng nhập mật khẩu</div></div>';  
if (email == "") {
...
function Redirect() {
               window.location="http://localhost:8080/web/templates/dk.jsp";
            }
