<%-- 
    Document   : login
    Created on : Nov 30, 2019, 12:14:38 AM
    Author     : ADMin
--%>
...
<span><label for="email" style="margin:5px 13px 0px 0px" class="xd">Tên đăng nhập</label>
...
<span><label for="password" style="margin-right:40.5px">Mật khẩu</label>   
