			...
			<div class="col-sm-12">
				...
				<div id="content" class="col-sm-8">
					...
					<div class="account-profile register-form">
						<form class="content" method="post" action="/updateInfo"
							id="edit-account">
							...
							<div class="form-group">
								<div class="input-wrap margin">
									...
									<label class="checkbox"><input type="checkbox"
										...
										onclick="change_password()"> Thay đổi mật khẩu</label>
								</div>
							</div>

							<script type="text/javascript">
function change_password(){
var ch=document.getElementById('is_change_pass');
if(ch.checked){
    document.innerHTML="<h1>Nubuybyvttrtc</h1>";
}
							...
							<div class="password-group">
								<div class="form-group">
									<label class="control-label" for="old_password">Mật
										khẩu cũ</label>
								...
								<div class="form-group">
									<%--@declare id="new-password"--%>
									<label class="control-label" for="new-password">Mật
										khẩu mới</label>
